@echo off
rem ---------------------------------------------------------------------
rem  Liga o inicio automatico: o CorreiaAtilhus2.0 passa a subir sozinho,
...
rem  - Poe um atalho "CorreiaAtilhus2.0" na Area de Trabalho, que so abre o
...
echo.
echo   Ligando o inicio automatico do CorreiaAtilhus2.0...

rem  Cria o atalho de inicializacao (wscript roda o .vbs escondido)
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
  "$s=(New-Object -ComObject WScript.Shell).CreateShortcut('%ATALHO%'); $s.TargetPath=Join-Path $env:SystemRoot 'System32\wscript.exe'; $s.Arguments='\"%~dp0iniciar-oculto.vbs\"'; $s.WorkingDirectory='%~dp0'; $s.Description='CorreiaAtilhus2.0 (inicio automatico)'; $s.Save()"
...
copy /y "%~dp0CorreiaAtilhus2.0.url" "%USERPROFILE%\Desktop\CorreiaAtilhus2.0.url" >nul
if exist "%USERPROFILE%\Desktop\CorreiaAtilhus2.0.url" (
...
echo     - o atalho "CorreiaAtilhus2.0" na Area de Trabalho abre no navegador.
echo.
